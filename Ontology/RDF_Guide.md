...
By virtual of this programming paradigm, in this document the formal description of the data model, i.e. the
...
1. A formal computer ontology expressed as RDF, called from here on OpenBiodiv Ontology, introducing
